      ...
      <div class="col-5">
        <div class="card profile-widget">
          ...
          <div class="profile-widget-description">
            <div class="profile-widget-name"><?php echo $detail->name; ?><div class="text-muted d-inline font-weight-normal">
                <div class="slash"></div><?php echo $detail->email; ?>
              </div>
            </div>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="form-group col-12">
                  ...
                  <textarea class="form-control summernote-simple" id="desc" name="desc" value=""><?php echo $detail->desc; ?></textarea>
                </div>
              </div>
            </div>
